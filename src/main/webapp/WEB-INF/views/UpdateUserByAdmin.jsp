		...
		<form action="Update.jsp" method="Post">
			<div class="form-group">
				<label for="username">Username:</label> <input type="text" name="name"
					id="username" value="<%=request.getAttribute("name") %>" required>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="text">Phone:</label> <input type="text" name="phone"
					id="password"value="<%=request.getAttribute("phone") %>" required>
			</div>
			<div class="form-group">
				<label for="password">Password:</label> <input type="text" name="password"
					id="age"value="<%=request.getAttribute("pass") %>" required>
			</div>
			<div class="form-group">
				<label for="text">Address:</label> <input type="text" name="address"
					id="password"value="<%=request.getAttribute("address") %>" required>
			</div>
